    ...
    if item_results:
        for item_dict in item_results:
            ...
            sinv = frappe.db.sql(""" select 
                                        ...
                                        ifnull(sum(`tabSales Invoice Item`.amount), 0) as amount
            ...
            data['amount'] = sinv[0][1]
            data['avg_rate'] = sinv[0][1] * item_dict.carton_cf / sinv[0][0] if sinv[0][0] else 0
